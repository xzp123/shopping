...
router.get('/', function(req, res, next) {
    ...
    var cart_number=
        ...
        `;
    var sql_address=`SELECT * FROM shopping.address WHERE username='${username.username}'`;
    connection1.query(sql_query, function (error, results1, fields) {
        ...
        connection2.query(cart_number, function (error, results2, fields) {
            ...
            connection3.query(sql_address, function (error, results3, fields) {
                var arr=[];
